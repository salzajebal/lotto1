  ...
  return (
    <div className="portal-b">
      ...
      <main>
        ...
        <section className="pb-shell pb-membership" id="membership"><div><p className="pb-eyebrow gold">LOTTORICO MEMBERSHIP</p><h2>이번 주 분석 기준을<br /><em>회원 전용으로 받아보세요.</em></h2><p>주간 분석 번호 · 리포트 · 결과 복기 · 회원 커뮤니티</p></div><div className="pb-price"><small>STANDARD / 1개월</small><strong>330,000<em>원</em></strong><button onClick={() => notify('멤버십 상담 신청을 준비 중입니다.')}>가입 상담 <ArrowRight size={15} /></button></div></section>
      ...
      <footer className="pb-footer"><div className="pb-shell"><div><b>로또리코</b><span>기록으로 확인하는 로또 분석 서비스</span></div><div><a href="#proof">당첨 증빙</a><a href="#method">분석 기준</a><a href="#membership">멤버십</a><a href="#community">커뮤니티</a></div><small>© 2025 로또리코 · 본 페이지의 번호는 분석 예시이며 당첨을 보장하지 않습니다.</small></div></footer>
